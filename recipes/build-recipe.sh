...
script -c "p4a create --force-build --require-perfect-match --debug --android_api 21 --arch armeabi --bootstrap empty --local_recipes . --dist_name recipe --requirements $RECIPE"
