...
class LibtorrentRecipe(Recipe):
    ...
    def build_arch(self, arch):
        ...
        with current_directory(self.get_build_dir(arch.arch)): #, 'bindings/python')):
        ...
        build_subdirs = 'gcc-arm/debug/boost-link-shared/boost-source/target-os-android/threading-multi' #visibility-hiddens
